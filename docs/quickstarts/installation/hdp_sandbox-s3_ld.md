...
title: Hortonworks (HDP) Sandbox to S3 with LiveData
...
* [Migration of data to S3](./hdp_sandbox-s3_lm.md)
...
1. Check that the `test_file` is now located in your `/testdir` directory in your S3 bucket.

_You have now set up live replication from your HDP Sandbox to your S3 bucket. Contact [WANdisco](https://wandisco.com/contact) for further information about Fusion and what it can offer you._
